...
def a2a_endpoint():
    return jsonify({
        ...
        "active": True,
        "x402support": True,
        "image": "https://blob.8004scan.app/b86c0187c4fe721e87964add0e4cdcd0b08c89ec89a305da636ff6413d3d9462.jpg", 
        "tags": [
            "AI",
            "autonomous",
            "superfluid",
        ...
        "version": "1.0.0",
        "description": "Aethera is a smart AI agent for easy data analysis. It helps you understand datasets, make charts, and forecast trends fast on the Base network",
        "services": [
            {
                "name": "MCP",
                "version": "2025-06-18",
